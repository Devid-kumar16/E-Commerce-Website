...
export default function Sidebar({ open = false, onClose = () => {}, categories = [], categoryImages = {} }) {
useEffect(() => {
...
<aside className={`absolute left-0 top-0 h-full w-[320px] bg-white shadow-xl transform transition-transform ${open ? 'translate-x-0' : '-translate-x-full'}`} role="dialog">
<div className="flex items-center justify-between p-4 border-b">
<div className="flex items-center gap-3">
<div className="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold">E</div>
<div>
<div className="font-semibold">Hello, Guest</div>
<div className="text-xs text-gray-500">Account & Lists</div>
</div>
</div>
<button onClick={onClose} aria-label="Close menu" className="p-2 rounded hover:bg-gray-100">✕</button>
</div>
